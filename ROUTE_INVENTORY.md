# TD Realty Ohio - Route Inventory
...
| URL | Status | Canonical URL | Page Title | H1 | Primary CTA Labels | Layout Components |
|-----|--------|---------------|------------|----|--------------------|-------------------|
| `/` | 200 | https://tdrealtyohio.com/ | 1% Commission Real Estate Brokerage Columbus OH \| TD Realty Ohio | Your Agent Works for You. Your Commission Shouldn't Work Against You. | I'm Selling, I'm Buying | Header, Footer |
...
## Area Pages (24 communities)

| URL | Community | Median Price | Population | Days on Market |
|-----|-----------|-------------|------------|----------------|
| `/areas/columbus/` | Columbus | $275K | 906K | 18 |
| `/areas/westerville/` | Westerville | $400K | 42K | 12 |
| `/areas/dublin/` | Dublin | $550K | 51K | 14 |
| `/areas/powell/` | Powell | $550K | 14K | 11 |
| `/areas/new-albany/` | New Albany | $650K | 12K | 15 |
| `/areas/gahanna/` | Gahanna | $375K | 36K | 13 |
| `/areas/hilliard/` | Hilliard | $425K | 37K | 12 |
| `/areas/upper-arlington/` | Upper Arlington | $600K | 36K | 10 |
| `/areas/worthington/` | Worthington | $425K | 15K | 11 |
| `/areas/grove-city/` | Grove City | $300K | 42K | 14 |
| `/areas/delaware/` | Delaware | $350K | 42K | 16 |
| `/areas/pickerington/` | Pickerington | $375K | 23K | 14 |
| `/areas/pataskala/` | Pataskala | $325K | 18K | 18 |
| `/areas/sunbury/` | Sunbury | $400K | 7K | 15 |
| `/areas/granville/` | Granville | $425K | 6K | 20 |
| `/areas/johnstown/` | Johnstown | $350K | 5K | 16 |
| `/areas/blacklick/` | Blacklick | $350K | 10K | 14 |
| `/areas/canal-winchester/` | Canal Winchester | $350K | 10K | 14 |
| `/areas/bexley/` | Bexley | $475K | 14K | 12 |
| `/areas/clintonville/` | Clintonville | $350K | 35K | 14 |
| `/areas/german-village/` | German Village | $500K | 8K | 18 |
| `/areas/grandview-heights/` | Grandview Heights | $450K | 8K | 10 |
| `/areas/lewis-center/` | Lewis Center | $500K | 35K | 12 |
| `/areas/reynoldsburg/` | Reynoldsburg | $300K | 40K | 15 |

## Blog Posts (10 articles)

| URL | Title |
|-----|-------|
| `/blog/1-percent-vs-3-percent-commission-comparison/` | 1% vs 3% Commission Comparison |
| `/blog/central-ohio-housing-market-2026/` | Central Ohio Housing Market 2026 |
| `/blog/closing-costs-columbus-ohio/` | Closing Costs in Columbus Ohio |
| `/blog/first-time-homebuyer-cash-back/` | First-Time Homebuyer Cash Back |
...
## Compare Pages (3 comparisons)

| URL | Comparison |
|-----|------------|
| `/compare/1-percent-vs-3-percent/` | 1% vs 3% Commission |
| `/compare/discount-broker-vs-full-service/` | Discount Broker vs Full Service |
| `/compare/flat-fee-mls-vs-full-service/` | Flat Fee MLS vs Full Service |

## Landing Pages (3 ad pages)

| URL | Target |
|-----|--------|
| `/lp/buy-home-columbus/` | Columbus Home Buyers |
| `/lp/sell-home-westerville/` | Westerville Home Sellers |
| `/lp/sell-home-columbus/` | Columbus Home Sellers |

## Additional Pages

| URL | Purpose |
|-----|---------|
| `/agents/` | Agent opportunities (100% listings, 90% buyer sides) |
...
| `/faq/` | FAQ page |
| `/sell-and-buy/` | Sell and Buy program details |
| `/sell-only-2-percent/` | Sell-only 2% program details |
...
- Compliance logos: Equal Housing, REALTOR, Columbus REALTORS, Ohio REALTORS
- Legal links: Privacy, Terms, Fair Housing, Site Map
- License info: Brokerage #2023006602, Broker #2023006467
