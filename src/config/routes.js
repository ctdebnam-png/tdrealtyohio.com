...
const { AGENT_COMPENSATION } = require('../content/messaging.js');
const { METADATA_STRINGS } = require('../content/metadata.js');
...
function buildRoutes() {
  return [
    {
      path: '/',
      title: METADATA_STRINGS.defaultTitle,
      description: METADATA_STRINGS.defaultDescription,
    ...
    { path: '/agents/', title: `Agents | ${BROKERAGE_FACTS.brandName}`, description: `Independent-agent brokerage with ${AGENT_COMPENSATION.listingSide.toLowerCase()}, ${AGENT_COMPENSATION.buySide.toLowerCase()}, and ${AGENT_COMPENSATION.rental.toLowerCase()}.`, pageType: PAGE_TYPES.SERVICE, priority: '0.6', changefreq: 'monthly', schema: ['BreadcrumbList'], parent: '/' },
