...
function buildRoutes() {
  ...
  // Core pages
  routes.push(
    { path: '/', title: 'TD Realty Ohio | Columbus, OH Real Estate', description: 'Central Ohio real estate with 1-2% listing commission and free pre-listing inspection. First-time buyers get 1% cash back.', pageType: PAGE_TYPES.HOME, priority: '1.0', changefreq: 'weekly', schema: ['Organization', 'RealEstateAgent', 'LocalBusiness'], parent: null },
    ...
    { path: '/sell-only-2-percent/', title: '2% Listing Commission | Sell Only | TD Realty Ohio', description: 'Selling without buying? List your home for 2% commission. Full MLS exposure, professional photos, and expert negotiation.', pageType: PAGE_TYPES.SERVICE, priority: '0.9', changefreq: 'monthly', schema: ['Service', 'LocalBusiness', 'BreadcrumbList'], parent: '/' },
    ...
    { path: '/about/', title: 'About TD Realty Ohio | Travis Debnam, Broker', description: 'Licensed Ohio broker since 2017. TD Realty Ohio offers full-service real estate at reduced commission rates.', pageType: PAGE_TYPES.ABOUT, priority: '0.7', changefreq: 'monthly', schema: ['LocalBusiness', 'BreadcrumbList'], parent: '/' },
