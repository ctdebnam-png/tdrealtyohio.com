    ...
    emailBtn.addEventListener('click', function() {
      ...
      form.addEventListener('submit', function(e) {
        ...
        submitToolLead({
          ...
          statusEl.textContent = ok ? 'Sent! Check your records.' : 'Error. Call (614) 956-8656.';
    ...
    textBtn.addEventListener('click', function() {
      ...
      form.addEventListener('submit', function(e) {
        ...
        submitToolLead({
          ...
          statusEl.textContent = ok ? 'Sent! We\'ll text you shortly.' : 'Error. Call (614) 956-8656.';
          statusEl.style.color = ok ? 'var(--success)' : 'var(--error)';
    ...
    sendBtn.addEventListener('click', function() {
      ...
      form.addEventListener('submit', function(e) {
        ...
        submitToolLead({
          ...
          statusEl.textContent = ok ? 'Sent! We\'ll be in touch soon.' : 'Error. Call (614) 956-8656.';
          statusEl.style.color = ok ? 'var(--success)' : 'var(--error)';
...
function exportToPDF(title, contentHtml) {
  ...
  printWindow.document.write(
    ...
    '<div class="footer"><p>Generated by TD Realty Ohio | tdrealtyohio.com | (614) 956-8656</p>' +
